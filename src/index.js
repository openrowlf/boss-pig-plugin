...
2. Call the Boss Pig MCP endpoint (POST ${mcpUrl}) with JSON-RPC: {"jsonrpc":"2.0","id":1,"method":"tools/call","params":{"name":"add_research_finding","arguments":{"interestId":"${interest.id}","title":"...","notes":"...","sourceUrl":"...","sourceName":"...","sourceType":"article","tags":"[\"tag1\",\"tag2\"]","temporalContext":"..."}}} to save each finding. Include: title, notes (with source URL), sourceUrl, sourceName, sourceType ("article"), tags as a JSON array string (e.g. "[\"keyword1\",\"keyword2\"]"), and temporalContext. IMPORTANT: always include interestId set to "${interest.id}" for every finding.
